...
const Navigation = () => {
  ...
  //@ts-ignore
  const { options, setOption, products, setProduct, allProducts, searchedProds, setSearchedProds } =
  ...
  let handleSearch = async () => {
    ...
    options.length > 0 ? (() => {setProduct(options); setSearchedProds(options)}).call(null) : setProduct(allProducts);
                  ...
                  {inputText.length > 0 &&
                    options.map((product, index) => (
                      <div className="product" key={index}>
                        {/* {console.log("123123123123hereeee", product, index)} */}
                            <img
                            ...
                            <p className="resPrices">{product.price}</p>
                      </div>
                    ))}
                </ul>
              </div>
